...
class Api():
    ...
    def creating_an_order_for_new_user(self, new_user_with_accesstoken):
        ...
        order_ingredients = {
            'ingredients': [Data.HASH_INGREDIENT_FLUO_BUN, Data.HASH_INGREDIENT_MEAT_MOLLUSC]}
