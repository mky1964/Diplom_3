...
class TestOrderFeed:
    ...
    def test_opening_order_details_in_order_feed(self, driver, new_user):
        ...
        main_page_1.click_on_order_feed_from_main_page(100)
    ...
    def test_order_num_from_order_history_present_in_order_feed(self, driver, new_user):
        ...
        account_1.click_on_orders_feed(100)
    ...
    def test_today_counter_adds_1_after_new_order(self, driver, new_user):
        ...
        new_user_with_accesstoken = api_1.registration_of_new_user(new_user)
        account_1.login_account_from_main_page(new_user, 60)
        response_set_order = api_1.set_an_order_api(new_user_with_accesstoken, 60)
        main_page_1.click_on_private_account_button_main_page(60)
        account_1.click_on_orders_feed(120)
        number_of_orders_today_1 = order_feed_1.get_number_of_orders_today_in_order_feed(60)
        api_1.set_an_order_api(new_user_with_accesstoken, 100)
        number_of_orders_today_2 = order_feed_1.get_number_of_orders_today_in_order_feed(100)
    ...
    def test_after_placing_an_order_number_appears_in_work(self, driver, new_user):
        ...
        response_set_order = api_1.set_an_order_api(new_user_with_accesstoken, 120)
        main_page_1.click_on_private_account_button_main_page(120)
        account_1.click_on_orders_feed(120)
        order_number_in_work_expected = order_feed_1.get_orders_number_in_work_in_order_feed_expected(response_set_order)

        order_number_in_work_actual = order_feed_1.get_orders_number_in_work_in_order_feed_actual(600)
