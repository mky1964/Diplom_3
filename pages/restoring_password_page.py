...
class RestorePassword(BasePage):
    ...
    @allure.step('click_on_restore_button_on_restore_password_page_1')
    def click_on_show_hide_button_on_placeholder_password_restore_page_2(self): # Клик по кнопке "показать-скрыть" на плейсхолдере  Password на вкладке "Восстановление пароля - 2
        self.find_element_located(RestoringPasswordPageLocators.RESTORING_PASSWORD_SHOW_HIDE_BUTTON_XPATH, 30)
        self.find_element_located(RestoringPasswordPageLocators.RESTORING_PASSWORD_SHOW_HIDE_BUTTON_XPATH, 30)
        self.find_element_located(RestoringPasswordPageLocators.RESTORING_PASSWORD_SHOW_HIDE_BUTTON_XPATH, 30)
        self.find_element_located(RestoringPasswordPageLocators.RESTORING_PASSWORD_SHOW_HIDE_BUTTON_XPATH, 30)
        self.click_on_element_located(RestoringPasswordPageLocators.RESTORING_PASSWORD_SHOW_HIDE_BUTTON_XPATH, 30)
